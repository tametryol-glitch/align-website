...
const GOOGLE_BTN_CLASS =
  'w-full flex items-center justify-center gap-2.5 bg-white text-[#1f1f1f] font-semibold px-6 py-3.5 rounded-xl shadow-lg shadow-black/20 transition-all hover:bg-gray-100 hover:scale-[1.02] active:scale-[0.98]';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="w-full max-w-md text-center">
          ...
          {/* Email not arriving? Google gets them in immediately. */}
          <div className="mt-7 pt-6 border-t border-border-primary">
            <p className="text-xs text-text-tertiary mb-3">
              Email still not here? Skip the wait — continue with Google and you&apos;re in straight away.
            </p>
            <button onClick={handleGoogleSignup} className={GOOGLE_BTN_CLASS}>
              <GoogleIcon />
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="card">
          ...
          {/* Recommended path: Google — instant, no confirmation email to wait on */}
          <div className="mb-4">
            <div className="flex items-center justify-center mb-2">
              <span className="inline-flex items-center gap-1 text-[10px] font-semibold uppercase tracking-wide text-green-400 bg-green-500/10 border border-green-500/25 rounded-full px-2 py-0.5">
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-bg-card text-text-muted">{t('auth.orSignUpWithEmail')}</span>
            </div>
          </div>
