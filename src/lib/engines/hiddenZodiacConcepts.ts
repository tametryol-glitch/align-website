...
export const PLANET_FUNCTIONS: Record<string, PlanetFunction> = {
  // The Sun carries the EARTHLY PURPOSE — what a person is here to accomplish on
  // this earth. Earth (its exact opposite) is the grounded inner self / roots.
  Sun: { fn: 'your earthly purpose — what you came here to accomplish, express, and become on this earth', verb: 'accomplish your earthly purpose', keywords: ['purpose', 'mission', 'direction', 'becoming'], relational: false, vocational: true },
  Earth: { fn: 'your inner core and grounding — the rooted self beneath your outward purpose', verb: 'ground and embody who you are', keywords: ['roots', 'essence', 'grounding', 'foundation'], relational: false, vocational: true },
...
export const PLANET_DOMAIN: Record<string, string> = {
  Sun: "your earthly purpose — what you're here to accomplish, express, and become in this physical life",
  Earth: "your inner core and grounding — who you are at your rooted centre, sitting exactly opposite your Sun's outward purpose",
