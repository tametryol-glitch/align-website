...
export const PLANET_MEANINGS: Record<string, string> = {
  ...
  'Toulouse-Lautrec': 'Toulouse-Lautrec is where your body set a limit and your talent went around it. Where this asteroid sits is where you were marked out early as different, stopped competing on the terms everyone else used, and built something nobody else could have made — from a vantage point only you had. You see the people polite society looks past, and you render them without pity or flattery. The shadow is using the wound as a reason to stay up all night among people who never ask you to be well.',

  Steinmetz: 'Steinmetz is the mind people do not see coming. Where this asteroid sits is where you are underestimated on sight — too small, too young, too odd — and where you settle it by being unmistakably the most capable person in the room. You do not argue with the assumption. You wait, then produce work that makes it embarrassing. The trap is needing the underestimation to perform at all, and quietly picking rooms where you will be doubted.',

  Hephaistos: 'Hephaistos is what you forge out of being cast out. Where this asteroid sits is where injury, disability or exclusion pushed you into making things — and where what you make is so good that the people who excluded you end up dependent on it. You are the one who builds the tools everyone else uses to win. The shadow is staying in the workshop, arming the people who get the glory, and calling it dignity.',

  Kant: 'Kant is the enormous structure you build from a very small life. Where this asteroid sits is where routine, restraint and relentless thinking produce something far larger than your circumstances — a system, a method, a body of principle others work inside for decades. You never needed to travel to get there. The cost is rigidity: you defend the framework long after reality has moved, and you mistake your discipline for a moral standard everyone should meet.',

  Picasso: 'Picasso is output as a force of nature. Where this asteroid sits is where you make far more than anyone asked for, reinvent your own style the moment you master it, and dominate a field by sheer volume and nerve rather than by height, polish or permission. You take what you want — from influences, from people — and make it unmistakably yours. The shadow is the wreckage: the people used as material, and the reinvention that is really an escape.',

  Voltaire: 'Voltaire is the small, sharp voice that makes powerful people furious. Where this asteroid sits is where you fight with wit instead of force — you are outmatched physically and you win anyway, in print, in public, in one sentence people repeat for years. You take up unpopular causes and cannot leave an injustice alone. The trap is that the same tongue that fights tyranny also wounds allies, and exile, professional or personal, keeps finding you.',

  Ganymed: 'Ganymed is the part of you that gets picked out of the crowd for how you look and carry yourself. Where this asteroid sits is where doors open before you have said anything — where your height, your face, your bearing does the first half of the work, and where you quietly resent that it does. The gift is access most people never get. The cost is never being sure whether you were chosen for what you can do or for how you look doing it. Ganymed asks you to become good enough that the answer stops mattering.',

  Artemis: 'Artemis is your aim. Where this asteroid sits is where you know exactly what you are hunting, go after it alone, and hit it — and where you will burn down any arrangement that tries to domesticate you first. You protect whoever cannot protect themselves here, especially the young, and you are colder than people expect toward anyone who threatens them. The trap is mistaking every close bond for a cage. Some of them are just company.',

  Adonis: 'Adonis is the beauty everyone wants a piece of. Where this asteroid sits is where you are desired — looked at, pursued, competed over — and where being wanted has quietly replaced being known. You learned early that your appearance opens rooms, and you have been paying the entry fee ever since. The shadow is a life built on being chosen rather than choosing. The gift arrives the day you use the attention to say something that costs you.',

  Phaethon: 'Phaethon is the part of you that demands the reins before you are ready. Where this asteroid sits is where you take on something far bigger than your experience to prove you have the right to it — and where the crash, when it comes, is spectacular and public. You are not reckless because you are stupid. You are reckless because a doubt about who you are got attached to this one thing. The power comes from taking the same ambition and serving your apprenticeship first.',
  ...
  Heracles: 'Heracles is where you are built to carry what would flatten other people. Where this asteroid sits is where your strength shows up — physical power, stamina, and the stubborn capacity to finish a labour everyone else walked away from. You do not trust anything you did not have to suffer for, so you quietly choose the hardest version of the task and call it standards. The trap is that you keep adding labours to prove you can, until your body sends the bill. Your real power is not how much you can lift. It is choosing which weight is worth lifting.',

  Atalante: 'Atalante is your speed — the part of you nobody catches. Where this asteroid sits is where you move faster than the room: quicker reflexes, quicker reads, quicker exits. You will not be slowed down or claimed by anyone who has not proved they can keep pace, and you have quietly beaten people who underestimated you. The trap is the golden apple — the shiny distraction rolled into your path at exactly the wrong moment, which costs you races you were already winning. Know which race is yours, and let everything else roll past.',

  Olympia: 'Olympia is the big stage and what it switches on in you. Where this asteroid sits is where you rise to official competition — the ranking, the final, the event with a name — and perform better under the lights than you ever do in practice. You hold yourself to an elite standard here whether or not anyone asked you to. The trap is needing a scoreboard to feel that anything counts, and ranking yourself against people who are not even competing with you. Keep one part of this life unmeasured, or you will lose the love that got you here.',

  Marathon: 'Marathon is your endurance — the ability to still be moving when everyone who started fast is walking. Where this asteroid sits is where you pace yourself, manage your energy, and outlast the competition through the long, unglamorous middle. You win by refusing to stop, not by being the most gifted. The trap is that the same quality keeps you in the job, the injury, or the situation years past the point it made sense, because quitting feels like losing. Know your sustainable pace — and know where your finish line actually is.',

  Spartacus: 'Spartacus is the fighter in you who will not kneel. Where this asteroid sits is where you resist — physically, competitively, and on principle — and where being cornered makes you steadier instead of weaker. People who have been pushed around tend to rally behind you. The trap is turning everything into a fight: treating every coach, boss or partner as a master to rebel against, and keeping the war going after it has already been won. Fight for something, not only against something, and you last far longer.',

  Victoria: 'Victoria is where you win — and where people see you win. Where this asteroid sits is where trophies, titles and public recognition collect, and where you have a sense for the exact moment that decides a contest. The trap is that winning becomes the only result that counts: second place feels like humiliation, and you stop trying anything you are not already good at. Celebrate each victory properly, then put it down. Your record is real evidence, but it is not who you are.',

  Hidalgo: 'Hidalgo is your nerve. Where this asteroid sits is where bigger opponents, louder rooms and worse odds make you bolder instead of smaller. You take the risk everyone else priced out, and you often win because nobody expected anyone to try. The trap is proving you are not afraid — taking a risk because it was offered rather than because it was smart, and picking a fight with the biggest person in the room on principle. Ask what the risk is for before you take it.',

  Panacea: 'Panacea is your comeback. Where this asteroid sits is where you recover — from injury, from setback, from the season everyone else wrote off — and where you know what actually helps a body heal, often before the expert does. The trap is chasing one magic fix, rushing back before you are healed to prove you are fine, or pouring everything into someone else\'s recovery while yours waits. There is no single cure. There is rest, rehab and patience, in that order, and your comeback is stronger when you stop trying to make it faster.',

  Fama: 'Fama is your reputation — what people say about you when you are not in the room. Where this asteroid sits is where your name travels faster than you do and your achievements turn into stories other people tell. It opens doors, but it is not the same as ability, and part of you knows that. The trap is managing the image instead of doing the work that built it, and being wounded by rumours you never admit hurt you. Keep your attention on the craft, not the coverage. A name with substance under it survives a bad headline.',

  Ascendant: 'Your Ascendant is the front door of your whole chart — the impression that forms before you have said anything worth judging. It is how you enter a room, the reflex you lead with when you are caught off guard, the body language you cannot fully control. People mistake it for your personality, and half the time so do you: this is the mask you wore so long it grew into your face. What lives here is not fake. It is the specific style every other part of your life gets delivered in.',

  Descendant: 'Your Descendant is the person you keep meeting. It sits directly opposite your Ascendant, which means it holds everything you never claimed as yours — the traits you admire, resent, and reliably fall for in someone else. This is the type: the partner, the business partner, the enemy who feels strangely personal. The pattern in your relationships is not bad luck and it is not their fault. It is this point, quietly casting the same character again and again until you finally develop the quality yourself.',

  MC: 'Your Midheaven is the highest point of your chart and the most public point of your life — what the world sees when it looks up at you. This is your reputation, your role, the answer strangers give when they describe you to someone else. It is the career that fits and the one that keeps quietly failing, the authority you are building toward, and the thing you will be remembered for whether or not it is the part of you you are proudest of. What sits here becomes your legacy by default. Choosing it on purpose is the work.',

  IC: 'Your IC is the deepest and most private point in your chart — the floor everything else stands on. This is home, lineage, the emotional climate you grew up inside and the one you unconsciously rebuild. Nobody sees this. It is where you retreat when you are done performing, what a room has to feel like before you can exhale, and the inherited story you are still either repeating or repairing. Everything visible about your life is built on top of whatever is buried here.',

  'Anti-Vertex': 'Your Anti-Vertex is the fate you initiate rather than the one you receive. Where the Vertex marks the encounters that arrive and rearrange you, this point marks the ones you walk into on purpose — the door you open, the message you send, the risk you take that the universe then answers. This is agency inside destiny: proof that not every turning point in your life happened to you. Some of them happened because you moved first.',
};
